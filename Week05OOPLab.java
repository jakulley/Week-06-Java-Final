...
public class Week05OOPLab {
	...
	public static void main(String[] args) {
		...
		Card newCard = new Card(11, "Spades");
		System.out.println(newCard.cardInfo());
		...
		startNotifier(createGame(5, 5), true);
	...
	public static Map<String, List<Card>> createGame(int players, int handSize) {
		Deck deck = new Deck();
	...
	public static void startNotifier(Map<String, List<Card>> players, boolean showCards) {
		for (String player : players.keySet()) {
			...
			if (showCards) {
				for (Card card : players.get(player)) {
					...
					System.out.println("drew " + players.get(player).size() + " cards.");
			}
		}
	}
}
